import 'package:auto_scroll_app/MoviesListView.dart';
import 'package:auto_scroll_app/data.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      double minScrollExtent4 = _scrollController4.position.minScrollExtent;
      double maxScrollExtent4 = _scrollController4.position.maxScrollExtent;
      //
      ...
      animateToMaxMin(maxScrollExtent3, minScrollExtent3, maxScrollExtent3, 20,
          _scrollController3);
      animateToMaxMin(maxScrollExtent4, minScrollExtent4, maxScrollExtent4, 10,
          _scrollController4);
    });
  }
